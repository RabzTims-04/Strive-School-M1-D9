...
const generateRandNumber = function(range){
  ...
  const randomNumDiv = document.getElementById('random-value-field')
  randomNumDiv.value = random
...
window.onload = function(){
  generateMainBoard()
  const randBtn = document.getElementById('randButton')
  const range = fillArray()
  randBtn.addEventListener('click', function(){
      generateRandNumber(range)
  })
  const userBoardBtn = document.getElementById('user-board-button')
